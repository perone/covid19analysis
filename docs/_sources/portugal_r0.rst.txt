**16/September** -- COVID-19 Time varying reproduction numbers estimation for Portugal
*****************************************************************************************
...
.. note:: This plot uses official data Data Science for Social Good Portugal, reports until
          16/September. This method is sensitive to changes in COVID-19
...
.. raw:: html
    ...
    <tr>
        <td>alentejo</td>
        <td>1.74 (1.35 - 2.25)</td>
    </tr>
    
    <tr>
        <td>algarve</td>
        <td>1.41 (1.11 - 1.76)</td>
    </tr>
    
    <tr>
        <td>centro</td>
        <td>1.37 (1.18 - 1.58)</td>
    </tr>
