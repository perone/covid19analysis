**12/June** -- COVID-19 Time varying reproduction numbers estimation for Brazil
*****************************************************************************************************
...
.. note:: This plot uses official data from government, reports until
          12/June. This method is sensitive to changes in COVID-19
...
.. raw:: html
    ...
    <tr>
        <td>RO</td>
        <td>1.34 (1.22 - 1.50)</td>
    </tr>
    
    <tr>
        <td>MT</td>
        <td>1.26 (1.15 - 1.37)</td>
    </tr>
    
    <tr>
        <td>SE</td>
        <td>1.24 (1.16 - 1.33)</td>
    </tr>
