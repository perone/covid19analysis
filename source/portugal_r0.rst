**28/September** -- COVID-19 Time varying reproduction numbers estimation for Portugal
*****************************************************************************************
...
.. note:: This plot uses official data Data Science for Social Good Portugal, reports until
          28/September. This method is sensitive to changes in COVID-19
...
.. raw:: html
    ...
    <tr>
        <td>algarve</td>
        <td>1.19 (1.03 - 1.38)</td>
    </tr>
    
    <tr>
        <td>centro</td>
        <td>1.13 (1.02 - 1.24)</td>
    </tr>
    
    <tr>
        <td>norte</td>
        <td>1.05 (1.00 - 1.10)</td>
    </tr>
