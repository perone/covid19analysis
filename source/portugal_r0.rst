**24/September** -- COVID-19 Time varying reproduction numbers estimation for Portugal
*****************************************************************************************
...
.. note:: This plot uses official data Data Science for Social Good Portugal, reports until
          24/September. This method is sensitive to changes in COVID-19
...
.. raw:: html
    ...
    <tr>
        <td>algarve</td>
        <td>1.18 (0.98 - 1.40)</td>
    </tr>
    
    <tr>
        <td>rlvt</td>
        <td>1.09 (1.03 - 1.14)</td>
    </tr>
    ...
    <tr>
        <td>centro</td>
        <td>0.97 (0.87 - 1.08)</td>
    </tr>
    
    <tr>
        <td>alentejo</td>
        <td>0.84 (0.70 - 0.99)</td>
    </tr>
