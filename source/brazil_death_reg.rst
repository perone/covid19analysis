...
the patient (death/cure) based on the reported symptoms covariates.
...
* Only states with more than 100 reported deaths on SIVEP system were used in the
  estimation;
...
* SIVEP data is observational data and correlation doesn't imply causation, this
  analysis is only a predictive model for the outcome being Death/Cure
  for COVID-19 based on the reported symptoms;
* The majority class (cure) was undersampled to match the same number of
  cases of samples of the minority class (death), in order to deal
...
.. note:: This plot uses official data from SIVEP system in Brazil, the maximum of the 
          notification date for this data was 06/June.
...
.. image:: _static/br/regression_death/reg_AL.png
  :width: 1200
...
.. image:: _static/br/regression_death/reg_AM.png
  :width: 1200
...
.. image:: _static/br/regression_death/reg_BA.png
  :width: 1200
...
.. image:: _static/br/regression_death/reg_CE.png
  :width: 1200
...
.. image:: _static/br/regression_death/reg_DF.png
  :width: 1200
...
.. image:: _static/br/regression_death/reg_ES.png
  :width: 1200
...
.. image:: _static/br/regression_death/reg_GO.png
  :width: 1200
...
.. image:: _static/br/regression_death/reg_MG.png
  :width: 1200
...
.. image:: _static/br/regression_death/reg_PA.png
  :width: 1200
...
.. image:: _static/br/regression_death/reg_PB.png
  :width: 1200
...
.. image:: _static/br/regression_death/reg_PE.png
  :width: 1200
...
.. image:: _static/br/regression_death/reg_PI.png
  :width: 1200
...
.. image:: _static/br/regression_death/reg_PR.png
  :width: 1200
...
.. image:: _static/br/regression_death/reg_RJ.png
  :width: 1200
...
.. image:: _static/br/regression_death/reg_RN.png
  :width: 1200
...
.. image:: _static/br/regression_death/reg_RS.png
  :width: 1200
...
.. image:: _static/br/regression_death/reg_SC.png
  :width: 1200
...
.. image:: _static/br/regression_death/reg_SP.png
  :width: 1200
